...
% Pass to this variable your complet data set path
% img = imread('C:\Users\Felipe\Documents\MATLAB\CVPR10-LLC\image\Caltech101\accordion\image_0001.jpg');
...
bag = bagOfFeatures(imgDs, 'CustomExtractor', extractor)

...
## [Handwritten Digit Classification (Mnist Dataset)](handwritten-digits\HANDWRITTEN-DIGITS.py)
...
## [Fake News Detector (Fake News Dataset)](fake-news\NLP_CLASSIFICAÇÃO_DE_FAKE_NEWS_USANDO_DEEP_LEARNING.ipynb)
...
## [Review Text Classification (Amazon Review Dataset)](review-classification\CLASSIFICAÇÃO_DE_TEXTO_USANDO_MACHINE_LEARNING.ipynb)
...
## [Word Cloud (Top Android Games Dataset)](wordcloud\WORD_CLOUD.ipynb)
...
## [Analise and Data Visualization](data-analise\ANALISE_E_VISUALIZAÇÃO_DOS_DADOS.ipynb)
